...
Shipped the public Enzo repository, original editorial web product, remote MCP service, Supabase schema and RLS policies, shared audit engine, plugin marketplace entry, portable skill, documentation, CI, and production deployments.
...
- Added Company Home, Company Memory, Decision Room, Artifacts, Decision Ledger, and Research Board surfaces.
...
## July 2026 founder operating system

- Added ten bounded mind packs, eight workrooms, eight output styles, and eight marketing and sales approaches.
- Added a founder-controlled composer with Enzo recommendations and founder overrides.
- Added Forward Deployed Engineering contracts and separate execution and deployment approval gates.
- Added eleven MCP tools for catalogs, workrooms, approvals, and deployment records.
- Added five portable functional workroom skills.
- Replaced the prior visual system with Enzo Broadsheet and an original white puppy identity.
